...
function View_product() {
  ...
  const viewProducts = async () => {
    ...
    const res = await axios.get('https://reacttops-561c8-default-rtdb.firebaseio.com/product.json');
  ...
  {
    fetch(`https://reacttops-561c8-default-rtdb.firebaseio.com/product.json`)
    .then((resp)=>resp.json())
  ...
  */
  ...
  const handelDelete = async (prod_id) => {
    ...
    if (ans) {
      const res = await axios.delete(`https://reacttops-561c8-default-rtdb.firebaseio.com/product/${prod_id}.json`);
      SetallProduct(res.data);
      viewProducts();
    }
  }
